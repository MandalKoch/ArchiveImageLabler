window.archiveImageLabler = window.archiveImageLabler || {};

window.archiveImageLabler.viewerKeys = {
...
window.archiveImageLabler.labelAffeKeys = {
    connect(dotNetReference) {
        this.disconnect();
        this.reference = dotNetReference;
        this.handler = event => {
...
window.archiveImageLabler.scrollActiveFilmstripItem = () => {
...
window.archiveImageLabler.scrollActiveLabelArchive = () => {
    requestAnimationFrame(() => {
